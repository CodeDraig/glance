...
type weatherWidget struct {
	...
	ShowAreaName bool                        `yaml:"show-area-name" json:"show-area-name"`
	HideLocation bool                        `yaml:"hide-location" json:"hide-location"`
	HourFormat   string                      `yaml:"hour-format" json:"hour-format"`
	Units        string                      `yaml:"units" json:"units"`
	Place        *openMeteoPlaceResponseJson `yaml:"-" json:"-"`
	Weather      *weather                    `yaml:"-" json:"-"`
	TimeLabels   [12]string                  `yaml:"-" json:"-"`
}
